...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // if(intval($reste_a_payer) !== 0){
        ...
        if ($x === 0 && intval($reste_a_payer) !== 0) { // s'il n'a pas deja de dette
            $sql1 = "INSERT INTO `laboratoire`
                (`code_patient_lab`, `code_personnel_lab`, `true_date`, `nature_examen`, `quantitee`, `prix`, `expression_des_resultats`, `conclusion`) 
                VALUES (:code_patient_lab, :code_personnel_lab, $DateActuele, :nature_examen, :quantitee, :prix, :expression_des_resultats, :conclusion);

                INSERT INTO `effectuer_op`(`code_personnel`, `id_caisse`, `motif`, `montant_aj`, `montant_re`) 
                VALUES (:code_personnel_lab, 1, :motif, :montant_aj, :montant_re);
            ...
            $requette1->bindParam(":code_patient_lab", $idPatient);
            $requette1->bindParam(":code_personnel_lab", $idSaver);
            $requette1->bindParam(":nature_examen", $NatureExam);
    ...
    // $sql1 = "INSERT INTO `laboratoire`
    //     (`code_patient_lab`, `code_personnel_lab`, `nature_examen`, `quantitee`, `prix`, `expression_des_resultats`, `conclusion`) 
    //     VALUES (:code_patient_lab, :code_personnel_lab, :nature_examen, :quantitee, :prix, :expression_des_resultats, :conclusion);
