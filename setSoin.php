...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // if(intval($reste_a_payer) !== 0){
        ...
        if ($x === 0 && intval($reste_a_payer) !== 0) { // s'il n'a pas deja de dette
            $sql1 = "INSERT INTO `soin`(`code_patient_soin`, `code_personnel_soin`, `true_date`, `nature_examen`, `quantitee`, `prix`, `responsable`) 
                VALUES (:code_patient_soin, :code_personnel_soin, $DateActuele, :nature_examen, :quantitee, :prix, :responsable);
            ...
            $requette1->bindParam(":code_patient_soin", $idPatient);
    ...
    //     (`code_patient_soin`, `code_personnel_soin`, `nature_examen`, `quantitee`, `prix`, `expression_des_resultats`, `conclusion`) 
    //     VALUES (:code_patient_soin, :code_personnel_soin, :nature_examen, :quantitee, :prix, :expression_des_resultats, :conclusion);
